...
function generatePackageJson(res) {
    ...
    let maintainers_name = global["talentui_info"]["maintainers name"];
    let maintainers_email = global["talentui_info"]["maintainers email"];
    let author_name = global["talentui_info"]['author name'];
    let author_email = global["talentui_info"]['author email'];
    let repository_type = global["talentui_info"]['repository type'];
    let repository_url = global["talentui_info"]['repository url'];
